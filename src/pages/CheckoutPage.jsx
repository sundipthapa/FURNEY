...
const CheckoutPage = () => {
    ...
    return (
        <>
            <Navbar />
            <div className="h-auto w-full flex justify-center p-10 gap-20">
                {/* Left section */}
                <div className="w-2/3 p-5 bg-white shadow-lg">
                    {/* Billing Details */}
                ...
                {/* Right section */}
                <div className="w-1/3 h-3/5 p-5 bg-white shadow-lg border border-light-brown flex flex-col justify-between">
                    <div>
