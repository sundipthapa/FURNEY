...
const FavoriteItemCard = ({ imageSrc, itemName, itemDescription, itemPrice, onAddToCart, onDeleteFavorite }) => {
  return (
    <div className="favorite-item-card p-4 border rounded-md shadow-sm flex gap-4 items-center">
      <img src={imageSrc} alt={itemName} className="w-32 h-32 object-cover rounded-md" />
