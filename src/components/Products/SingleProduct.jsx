...
const SingleProductCard = ({ product,onClick, bgColor }) => {
  ...
  return (
    <div className={`flex-shrink-0 m-2 relative overflow-hidden ${bgColor} rounded-lg max-w-sm shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-xl `}>
